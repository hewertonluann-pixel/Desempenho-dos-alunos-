...
// Inclui feedback visual de loading no botão exportar durante a geração
...
function ativarLoadingNoBotao(btn) {
  ...
  btn.disabled = true;
  btn.innerHTML = `
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="animation:fa-spin 0.8s linear infinite;display:inline-block;vertical-align:middle;margin-right:6px;">
...
function restaurarBotao(btn) {
  btn.innerHTML = btn.dataset.originalHTML || "🖼️ Exportar";
...
export async function exportarChamada3Colunas() {
  ...
  ativarLoadingNoBotao(btnExportar);
  ...
  try {
    ...
    statusHoje === "P"
      ...
      : statusHoje === "F"
        ...
        : statusHoje === "FJ"
          ? { icon: "●", label: "just.", cor: "#fbbf24", fundo: "rgba(217,119,6,0.10)" }
